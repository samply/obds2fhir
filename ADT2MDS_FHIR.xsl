...
<!--            <Tumor_Diagnosedatum><xsl:apply-templates select="number(replace($diagnoseDatum,'\d\d\.\d\d\.(\d\d\d\d)$','$1'))"/></Tumor_Diagnosedatum>-->
    ...
    <xsl:template match="Verlauf">
        <Verlauf>
            ...
            <xsl:if test="Verlauf_Lokaler_Tumorstatus"><!--Lokales-regionäres_Rezidiv + zugehöriges Datum-->
                ...
                <Datum_lokales-regionäres_Rezidiv><xsl:apply-templates select="Untersuchungsdatum_Verlauf/node()"/></Datum_lokales-regionäres_Rezidiv>
            </xsl:if>
            <xsl:if test="Verlauf_Tumorstatus_Lymphknoten"><!--Lymphknoten-Rezidiv + zugehöriges Datum-->
                ...
                <Datum_Lymphknoten-Rezidiv><xsl:apply-templates select="Untersuchungsdatum_Verlauf/node()"/></Datum_Lymphknoten-Rezidiv>
            </xsl:if>
            <xsl:if test="Verlauf_Tumorstatus_Fernmetastasen"><!--Lymphknoten-Rezidiv+ zugehöriges Datum-->
                ...
                <Datum_Fernmetastasen><xsl:apply-templates select="Untersuchungsdatum_Verlauf/node()"/></Datum_Fernmetastasen>
            </xsl:if>
            ...
            <xsl:if test="Untersuchungsdatum_Verlauf"><Untersuchungs-Befunddatum_im_Verlauf><xsl:value-of select="Untersuchungsdatum_Verlauf"></xsl:value-of></Untersuchungs-Befunddatum_im_Verlauf></xsl:if><!--Untersuchungs-Befunddatum_im_Verlauf-->
    ...
    <xsl:template match="SYST">
        <SYST>
            ...
            <xsl:if test="Menge_Substanz/SYST_Substanz"><Systemische_Therapie_Substanzen><xsl:value-of select="Menge_Substanz/SYST_Substanz"/></Systemische_Therapie_Substanzen></xsl:if>
        </SYST>
    </xsl:template>
    ...
    <xsl:template match="Bestrahlung">
        <Bestrahlung>
            ...
            <xsl:if test="ST_Beginn_Datum"><ST_Beginn><xsl:value-of select="ST_Beginn_Datum"/></ST_Beginn></xsl:if>
            <xsl:if test="ST_Ende_Datum"><ST_Ende><xsl:value-of select="ST_Ende_Datum"/></ST_Ende></xsl:if>
            <xsl:if test="ST_Applikationsart"><ST_Applikationsart><xsl:value-of select="ST_Applikationsart"/></ST_Applikationsart></xsl:if>
            <xsl:if test="ST_Gesamtdosis"><ST_Gesamtdosis><xsl:value-of select="ST_Gesamtdosis"/></ST_Gesamtdosis></xsl:if>
            <xsl:if test="ST_Einzeldosis"><ST_Einzeldosis><xsl:value-of select="ST_Einzeldosis"/></ST_Einzeldosis></xsl:if>
        </Bestrahlung>
    </xsl:template>
